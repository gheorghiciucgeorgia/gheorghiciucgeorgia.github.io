...
const AboutMe = () => {
    ...
    return (
        <div ref={aboutMeRef} className='aboutMe-section w-full bg-[var(--secondary-color)] flex flex-col lg:flex-row justify-between items-center py-[4vw] lg:py-[2vw] px-[7vw] relative before:top-[-6px] md:before:top-[-18px] xl:before:top-[-35px]' id="About">
            ...
            <div ref={bottomRef} className='aboutMe-bottom absolute bottom-[3px] italic text-[10px] lg:text-[16px] left-[8px] line-height-[110%] text-[var(--accent-color)] opacity-80'>
