      ...
      <div className='header h-auto overflow-hidden relative'>
        ...
        <div className='flex flex-col justify-center -mb-30 md:-mb-50 md:-mt-20 lg:mb-0 lg:mt-0 lg:justify-between lg:flex-row items-center h-auto lg:gap-18'>
          ...
          <div className='glitch-name paused font-medium flex flex-col text-center' ref={glitchNameRef}>
            <h2 className="hero glitch layers" data-text="GHEORGHICIUC"><span className="select-none cursor">GHEORGHICIUC</span></h2>
            <h2 className="hero glitch layers" data-text="GEORGIA"><span className="select-none cursor">GEORGIA</span></h2>
            <p className='hero glitch layers text-custom' data-text="Front-end Developer"><span className="select-none cursor">Front-end Developer</span></p>
            <p className='hero tagline' data-text="Crafting interfaces from the neon grid"><span className="select-none cursor">Crafting interfaces from the neon grid</span></p>
          </div>
          {renderFrame2()}
        </div>
      </div>
